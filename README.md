...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-v0.2.0--beta.4-blue" />
  <img alt="Tauri" src="https://img.shields.io/badge/Tauri-2-24C8DB" />
</p>

> 当前版本：`v0.2.0-beta.4`。项目处于 MVP beta 阶段，功能边界以 [docs/PRD.md](docs/PRD.md) 为准。
